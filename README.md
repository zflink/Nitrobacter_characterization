...
* `NOB_environment.yml` file contains the description of the Conda environment used for data processing, except for the creation of operon synteny plots which use [Clinker](https://github.com/gamcil/clinker) and should be in a separate environment as described in the Clinker installation procedure.
